          ...
          if (prev) {
            ...
            if (idx >= 0) {
              next[idx] = {
                ...
                group: r.group,
                url: r.url,
                targetUrl: r.targetUrl ?? prev.targetUrl,
                relevantGoogle: r.relevantGoogle ?? prev.relevantGoogle,
                relevantYandex: r.relevantYandex ?? prev.relevantYandex,
            ...
            next.push({
              ...
              relevantGoogle: r.relevantGoogle,
              relevantYandex: r.relevantYandex,
